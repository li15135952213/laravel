...
@csrf
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="radio" name="shows" value="显示" checked>显示
			<input type="radio" name="shows" value="不显示">不显示
		</div>
	</div>
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">文章作者</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" id="firstname" name="write" placeholder="请输入文章作者">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="email" class="form-control" id="firstname" name="email" placeholder="请输入作者email">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" id="firstname" name="name" placeholder="请输入关键字">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<textarea  class="form-control" id="品牌描述firstname" name="content" placeholder="请输入网页描述"></textarea>
